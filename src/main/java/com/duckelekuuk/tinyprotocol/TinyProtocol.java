package com.duckelekuuk.tinyprotocol;


import com.duckelekuuk.tinyprotocol.Reflection.FieldAccessor;
import com.duckelekuuk.tinyprotocol.Reflection.MethodInvoker;
...
public abstract class TinyProtocol {
    ...
    private static final FieldAccessor<PlayerConnection> getConnection = Reflection.getField("{nms}.server.level.EntityPlayer", PlayerConnection.class, 0);
    private static final FieldAccessor<NetworkManager> getManager = Reflection.getField("{nms}.server.network.PlayerConnection", NetworkManager.class, 0);
    private static final FieldAccessor<Channel> getChannel = Reflection.getField("{nms}.network.NetworkManager", Channel.class, 0);
    ...
    private static final MethodInvoker getNetworkMarkers = Reflection.getTypedMethod(serverConnectionClass, null, List.class);

    // Packets we have to intercept
    private static final Class<?> PACKET_LOGIN_IN_START = Reflection.getMinecraftClass(".network.protocol.login","PacketLoginInStart");
